...
| --- | --- | --- | --- |
| Frontier (leader) | `unicom/glm-5` | high | Primary leader/orchestrator for planning, coordination, and frontier-class reasoning. |
...
| `analyst` | `unicom/glm-5` | medium | Requirements clarity, acceptance criteria, hidden constraints (frontier-orchestrator, frontier) |
| `planner` | `unicom/glm-5` | medium | Task sequencing, execution plans, risk flags (frontier-orchestrator, frontier) |
| `architect` | `unicom/glm-5` | high | System design, boundaries, interfaces, long-horizon tradeoffs (frontier-orchestrator, frontier) |
| `debugger` | `gpt-5.4-mini` | high | Root-cause analysis, regression isolation, failure diagnosis (deep-worker, standard) |
| `executor` | `unicom/glm-5` | high | Code implementation, refactoring, feature work (deep-worker, standard) |
| `team-executor` | `unicom/glm-5` | medium | Supervised team execution for conservative delivery lanes (deep-worker, frontier) |
...
| `security-reviewer` | `unicom/glm-5` | medium | Vulnerabilities, trust boundaries, authn/authz (frontier-orchestrator, frontier) |
| `performance-reviewer` | `gpt-5.4-mini` | medium | Hotspots, complexity, memory/latency optimization (frontier-orchestrator, standard) |
| `code-reviewer` | `unicom/glm-5` | high | Comprehensive review across all concerns (frontier-orchestrator, frontier) |
| `dependency-expert` | `gpt-5.4-mini` | high | External SDK/API/package evaluation (frontier-orchestrator, standard) |
| `test-engineer` | `unicom/glm-5` | medium | Test strategy, coverage, flaky-test hardening (deep-worker, frontier) |
...
| `code-simplifier` | `unicom/glm-5` | high | Simplifies recently modified code for clarity and consistency without changing behavior (deep-worker, frontier) |
...
| `critic` | `unicom/glm-5` | high | Plan/design critical challenge and review (frontier-orchestrator, frontier) |
| `vision` | `unicom/glm-5` | low | Image/screenshot/diagram analysis (fast-lane, frontier) |
<!-- OMX:MODELS:END -->
...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775903007324-xu4hwo | 2026-04-11T10:23:27.361Z

**Codebase Map:**
  frontend/: admin-request-templates, admin-users, admin-workflows, auth, departments, forms, http, positions, request-templates, requests
