-- Baseline seed data for approval-system
-- Generated from local database state on 2026-04-22
-- Usage:
--   mysql -h <host> -P <port> -u <user> -p approval_system < docs/sql/2026-04-22-baseline-seed-from-current-db.sql
--
-- IMPORTANT:
-- 1) Run this after application schema is ready (tables already created).
-- 2) This script will reset and rewrite core master/config data tables.
-- 3) This script does NOT import Flowable ACT_* runtime/history tables.

USE approval_system;
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- Reset core master/config tables (idempotent re-seed)
DELETE FROM workflow_publish_log;
DELETE FROM workflow_node_config;
